...
public class ModuleUtil extends ModuleHelper {
    ...
    /*
        Type: dropdown
        Ref:  Trench/Trench/Subsquare
     */
    public static View get_Trench_Trench_Subsquare(Solo solo) {
        String ref = "Trench/Trench/Subsquare";
        return (android.view.View) solo.getView((Object) ref);
    }
    ...
    /*
        Type: input
        Ref:  FCN/General/Area
     */
    public static EditText get_FCN_General_Area(Solo solo) {
        String ref = "FCN/General/Area";
        return (android.widget.EditText) solo.getView((Object) ref);
    }
    ...
    /*
        Type: input
        Ref:  Stratum_Feature/General/Mid_X
     */
    public static EditText get_StratumFeature_General_MidX(Solo solo) {
        String ref = "Stratum_Feature/General/Mid_X";
        return (android.widget.EditText) solo.getView((Object) ref);
    }

    /*
        Type: input
        Ref:  Stratum_Feature/General/Mid_Y
     */
    public static EditText get_StratumFeature_General_MidY(Solo solo) {
        String ref = "Stratum_Feature/General/Mid_Y";
        return (android.widget.EditText) solo.getView((Object) ref);
    }
    ...
    /*
        Type: input
        Ref:  Trench/Trench/Area
     */
    public static EditText get_Trench_Trench_Area(Solo solo) {
        String ref = "Trench/Trench/Area";
        return (android.widget.EditText) solo.getView((Object) ref);
    }
    ...
    /*
        Type: input
        Ref:  Trench/Trench/X_Coordinate
     */
    public static EditText get_Trench_Trench_XCoordinate(Solo solo) {
        String ref = "Trench/Trench/X_Coordinate";
        return (android.widget.EditText) solo.getView((Object) ref);
    }

    /*
        Type: input
        Ref:  Trench/Trench/Y_Coordinate
     */
    public static EditText get_Trench_Trench_YCoordinate(Solo solo) {
        String ref = "Trench/Trench/Y_Coordinate";
        return (android.widget.EditText) solo.getView((Object) ref);
    }
